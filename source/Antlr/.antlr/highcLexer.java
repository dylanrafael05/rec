...
public class highcLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"SLComment", "MLComment", "Var", "Let", "If", "Else", "While", "Fn", 
			"Continue", "Break", "Defer", "Type", "Struct", "Template", "New", "Return", 
			"For", "Mod", "Use", "Auto", "And", "Not", "Or", "True", "False", "Uninit", 
			"Identifier", "Integer", "Float", "String", "Plus", "Minus", "Star", 
	...
	public highcLexer(CharStream input) {
		super(input);
